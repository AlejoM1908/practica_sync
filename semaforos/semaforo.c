...
struct datos_tipo_sem
{
    int dato;
    int p;
}

    * procesoSem(void *datos)
{
    struct datos_tipo_sem *datos_proceso;
    datos_proceso = (struct datos_tipo_sem *)datos;
    int a, i, j, p;
    sem_wait(semaforo);
...
int initSem()
{
    ...
    struct datos_tipo_sem hilo1_datos, hilo2_datos;
    ...
    error = pthread_create(&idhilo1, NULL, (void *)procesoSem, (void *)(&hilo1_datos));
    if (error != 0)
    {
    ...
    error = pthread_create(&idhilo2, NULL, (void *)procesoSem, (void *)(&hilo2_datos));
    if (error != 0)
    {
